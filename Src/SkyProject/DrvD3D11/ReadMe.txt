========================================================================
    STATISCHE BIBLIOTHEK: DrvD3D11-Projektübersicht
========================================================================

Dieses DrvD3D11-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre DrvD3D11-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen DrvD3D11.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
